...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project.txt', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.project.txt', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.project.txt', 'contacts', 0, 'email'): 'Author-email',
