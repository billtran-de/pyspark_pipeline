...
class Pep517HookCaller(object):
    ...
    def prepare_metadata_for_build_wheel(
        ...
        """Prepare a ``*.dist-info`` folder with metadata for this project.txt.
    ...
    def build_wheel(
        ...
        """Build a wheel from this project.txt.
    ...
    def build_editable(
            self, wheel_directory, config_settings=None,
            metadata_directory=None):
        """Build an editable wheel from this project.txt.
    ...
    def build_sdist(self, sdist_directory, config_settings=None):
        """Build an sdist from this project.txt.
