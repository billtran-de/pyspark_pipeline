...
class LinkEvaluator:
    ...
    """
    Responsible for evaluating links for a particular project.txt.
    """
    ...
    def evaluate_link(self, link: Link) -> Tuple[bool, Optional[str]]:
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if canonicalize_name(wheel.name) != self._canonical_name:
                    reason = "wrong project.txt name (not {})".format(self.project_name)
                    return (False, reason)
        ...
        if not version:
            reason = f"Missing project.txt version for {self.project_name}"
            return (False, reason)
...
def filter_unallowed_hashes(
    ...
    if not hashes:
        logger.debug(
            "Given no hashes to check %s links for project.txt %r: "
    ...
    logger.debug(
        "Checked %s links for project.txt %r against %s hashes "
...
class PackageFinder:
    ...
    def process_project_url(
        ...
        logger.debug(
            "Fetching project.txt page and analyzing links: %s",
            project_url,
        )
    ...
    def find_best_candidate(
        ...
        """Find matches for the given project.txt and specifier.
