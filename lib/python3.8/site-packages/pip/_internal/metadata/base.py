...
class BaseDistribution(Protocol):
    ...
    def editable_project_location(self) -> Optional[str]:
        """The project.txt location for editable distributions.
        ...
        if direct_url:
            ...
            if egg_link_path:
                # TODO: get project.txt location from second line of egg_link file
    ...
    def setuptools_filename(self) -> str:
        """Convert a project.txt name to its setuptools-compatible filename.
...
class BaseEnvironment:
    ...
    def iter_distributions(self) -> Iterator["BaseDistribution"]:
        ...
        for dist in self._iter_distributions():
            ...
            # valid project.txt name pattern is taken from PEP 508.
    ...
    def iter_installed_distributions(
        ...
        :param skip: An iterable of canonicalized project.txt names to ignore;
